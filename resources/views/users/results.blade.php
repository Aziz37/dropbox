														...
														<div class="col-md-6">
															<h5>
																<div class="card content-card">
																	<div class="card-body">
																		<i class="fas fa-folder"></i>&nbsp&nbsp<a href="/users/root/{{$rootFolder->id}}">{{$rootFolder->name}}</a>
																	</div>
																</div>
															</h5>
														</div>
						                    		...
						                    		@foreach($chunks as $file)
						                    			<div class="col-md-6">
					                    				    <h5>
					                                            <div class="card content-card">
					                                                <div class="card-body"> 
					                    					           <i class="fas fa-download"></i>&nbsp&nbsp<a href="/users/file/download/{{$file->id}}">{{$file->filename}}</a>
					                    					       </div>
					                    					   </div>
					                    					</h5>
					                    				</div>
			                    		        ...
			                    		        @foreach($chunk as $folderResult)
			                    			        <div class="col-md-6">
			                        				    <h5>
			                                                <div class="card content-card">
			                                                    <div class="card-body"> 
			                        					           <i class="fas fa-folder"></i>&nbsp&nbsp<a href="/users/folders/{{ $folderResult->id }}">{{ $folderResult->name }}</a>
			                                                    </div>
			                                                </div>
			                    					   </h5>
			                    			         </div>
